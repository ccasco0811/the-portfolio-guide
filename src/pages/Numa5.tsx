      ...
      <div className="flex flex-col items-center gap-20 px-10 pb-20 max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="self-stretch inline-flex justify-center items-center gap-5 flex-wrap content-center">
            {[
              { title: "Awareness", description: "Discovers NUMA through Google searches, Facebook ads, and word of mouth. Learns there is a simpler way to invoice using WhatsApp.", gap: "gap-4" },
              { title: "Consideration", description: "Visits landing page, watches a 30 second video, calculates savings, and shares phone number and email.", gap: "gap-4" },
              { title: "Decision", description: "Requests more details through WhatsApp, asks colleagues, and signs up for early access.", gap: "gap-4" },
              { title: "Onboarding", description: "Uploads a CSD (digital tax certificate required by Mexico's SAT), receives the shared WhatsApp number, issues a first invoice, and shares it with staff.", gap: "gap-2" },
              { title: "Adoption", description: "Starts invoicing daily, reviews summaries, and reduces reliance on an accountant.", gap: "gap-2" },
              { title: "Advocacy", description: "Recommends NUMA in WhatsApp groups, shares experience on social media, and refers other business owners.", gap: "gap-2" }
            ].map((item, index) => (
